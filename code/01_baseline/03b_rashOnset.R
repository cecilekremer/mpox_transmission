...
summary(data.si$rash_onset)
table(data.si$n.lesion.anal); table(data.si$n.lesion.genital)
...
#                        symptom.onset = as.Date(data.si$rash_onset),
...
load('code/01_baseline/trees_281024_rash.RData')
load('code/01_baseline/onsets_281024_rash.RData')
load('code/01_baseline/routes_281024_rash.RData')
...
jpeg('results/baseline/rash/plotConvergence.jpeg', width = 30, height = 30, units = 'cm', res = 300)
...
jpeg('results/baseline/rash/plotFitMostLikely.jpeg', width = 30, height = 20, units = 'cm', res = 300)
par(mfrow = c(2, 1))
...
library(plot.matrix)
library(RColorBrewer)
jpeg("results/baseline/rash/agemat.jpeg", width=10, height=10, units="cm", res=300)
# par(mar=c(5.1, 4.1, 4.1, 4.1))
...
jpeg('results/baseline/rash/plotNetwork.jpeg', width = 50, height = 50, units = 'cm', res = 300)
par(mfrow = c(1,1))
...
# Plot cdf
jpeg('results/baseline/rash/plotCDF.jpeg', width = 30, height = 20, units = 'cm', res = 300)
bsLO <- min(xS$sL) - 0.5
bsRO <- max(xS$sR) + 0.5
...
jpeg('results/baseline/rash/plotCDFnonSexual.jpeg', width = 30, height = 20, units = 'cm', res = 300)
par(mfrow = c(1,1))
# Empirical CDF
...
jpeg('results/baseline/rash/plotCDFSexual.jpeg', width = 30, height = 20, units = 'cm', res = 300)
par(mfrow = c(1,1))
# Empirical CDF
