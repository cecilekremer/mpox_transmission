...
# ## Sample networks --> VSC
# source('code/02_sensitivityI/functions/fun_network.R')
# # 
# num.nets <- 1000
...
load('code/02_sensitivityI/trees_221024_sens1.RData')
load('code/02_sensitivityI/onsets_221024_sens1.RData')
load('code/02_sensitivityI/routes_221024_sens1.RData')
...
source('code/02_sensitivityI/functions/fun_mcmc_si_strat.R')
...
library(EpiLPS)
source('code/02_sensitivityI/functions/estimSI_boot.R')
